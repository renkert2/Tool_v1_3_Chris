    ...
    methods
        ...
        function generateGraph(obj)
           ...
           % Graph Edge Properties
            ...
            Edge(2,1) = Graph_Edge('PowerType',[{'1'}],'Coefficient',1,'Input',1,'Port',3);
            Edge(3,1) = Graph_Edge('PowerType',[{'1'}],'Coefficient',1,'Input',2,'Port',2);
            Edge(4,1) = Graph_Edge('PowerType',[{'1'}],'Coefficient',1,'Input',2,'Port',4);
            Edge(5,1) = Graph_Edge('PowerType',[{'2','3'}],'Coefficient',[obj.HTC -obj.HTC]);
