classdef NonpressurizedLiquidTank < matlab.mixin.Copyable
    ...
    properties
        ...
        % Working Fluid
        fluid_props char
        % Initial tank mass [lb]
        initial_mass_lb(1,1) double {mustBeNumeric}
        % initial tank volume [in^3]
        initial_volume_in3(1,1) double {mustBeNumeric}
        % initial tank temperature [R]
        initial_temperature_R(1,1) double {mustBeNumeric}
        % tank volume [in^3]
        tank_volume_in3(1,1) double {mustBeNumeric}
        % Component Graph
    ...
    methods
        ...
        function generateGraph(obj)
            ...
            obj.Comp_Graph.Nev = 3;
            % Number of Graph External Edges
            obj.Comp_Graph.Nee = 1;
            ...
            % Defines the type of constant coefficient power flow types in the
            ...
            Vertex(1,1) = Graph_Vertex('DynType',1,'Capacitance',1,'Initial',obj.initial_temperature_R,'CapType',[{'1'}],'ExtEdge',[1],'FcnType',[{'2'}],'FcnBkpt',[2],'BkptType',[1],'FcnCoefficient',1);
            Vertex(2,1) = Graph_Vertex('Capacitance',1,'Initial',obj.initial_mass_lb,'CapType',[{'1'}],'FcnType',[{'1'}]);
            Vertex(3,1) = Graph_Vertex('FcnCoefficient',0);
            Vertex(4,1) = Graph_Vertex('FcnCoefficient',0);
            Vertex(5,1) = Graph_Vertex('FcnCoefficient',0);
            ...
            Edge(1,1) = Graph_Edge('PowerType',[{'1'}],'Coefficient',1,'Input',1,'Port',1);
            Edge(2,1) = Graph_Edge('PowerType',[{'1'}],'Coefficient',1,'Input',2,'Port',2);
            Edge(3,1) = Graph_Edge('PowerType',[{'2'}],'Coefficient',1,'Input',[1 2]);
            Edge(4,1) = Graph_Edge('PowerType',[{'3'}],'Coefficient',1,'Input',[1 2]);
