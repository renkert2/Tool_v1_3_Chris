classdef ExternalHeat < matlab.mixin.Copyable
    ...
    methods
        ...
        function generateGraph(obj)
            ...
            Vertex(1,1) = Graph_Vertex('DynType',1,'Capacitance',0,'CapType',[{'1'}],'ExtEdge',[1]);
            Vertex(2,1) = Graph_Vertex('FcnCoefficient',0);
            ...
            Edge(2,1) = Graph_Edge('PowerType',[{'1'}],'Coefficient',1,'Input',1,'Port',2);
