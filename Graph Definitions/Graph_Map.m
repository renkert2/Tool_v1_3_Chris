classdef Graph_Map 
    ...
    properties
        ...
        % Breakpoints
        % this property defines the breakpoints for the associated lookup
        Bkpts(:,:) 
        
        % Map
        % this property is the lookup map
        Map double {mustBeNonNan}
        
        % Product or Division
        % This property defines how the map "g" affects the Power flow "P_full" 
        % [1] indicates that P_full = P*g
        % [2] indicates that P_full = P/g
        ProOrDiv(1,1) uint8 
